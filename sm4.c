...
void SM4_encrypt(unsigned char *in, unsigned char *out, sm4_context *ks){
    sm4_one_round(ks->sk, in, out);
}

void SM4_decrypt(unsigned char *in, unsigned char *out, sm4_context *ks){
    sm4_one_round(ks->sk, in, out);
}
